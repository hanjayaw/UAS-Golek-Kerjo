...
def profile():
    if "user" in session:
        sqlutama = "SELECT `nama_pekerja`,`jenis_kelamin`,`umur_pekerja`,`pendidikan_terakhir`,`alamat`,SUBSTRING(kota, LOCATE(' ', kota)+1),`provinsi`,`telepon_pekerja`,`email`,`instagram`,`linkedin`,`tipe_pekerjaan`,`durasi_pekerjaan`,`preferensi_gaji`,`ktp`FROM pekerja,kota,provinsi WHERE pekerja.id_kota = kota.id_kota and pekerja.id_provinsi = provinsi.id_provinsi and id_pekerja = \'" + session[
            "iduser"].upper() + "\';"
        # return sqlutama
        ...
        sqlhistori = (
            "SELECT `nama_perusahaan` , `nama_pekerja` , `tanggal_upload` FROM pekerjatoperusahaan pj ,pekerja,perusahaan WHERE pj.id_pekerja = pekerja.id_pekerja and pj.id_perusahaan = perusahaan.id_perusahaan and pj.id_pekerja = \'"
            + session["iduser"].upper() + "\';")
        histori = RunSelect(sqlhistori)
        member = (
            "SELECT `jenis_membership` FROM pekerja p, membership m where p.id_membership = m.id_membership and p.id_pekerja = \'"
            + session["iduser"].upper() + "\';")
        ...
        if request.method == "POST":
            ...
            if nama != "" and nama != None:
                session["user"] = nama
                qry = 'CALL updatenama (\'' + nama + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if gender != "" and gender != None:
                qry = 'CALL updatejeniskelamin (\'' + gender + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if umur != "" and umur != None:
                qry = 'CALL updateumur (\'' + umur + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if lulusan != "" and lulusan != None:
                #qry += ", pendidikan_terakhir = \'" + lulusan + "\'"
                qry = 'CALL updatelulusan (\'' + lulusan + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if alamat != "" and alamat != None:
                ...
                #qry += ", alamat = \'" + alamat + "\'"
                qry = 'CALL updatealamat(\'' + alamat + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if kotanya != "" and kotanya != None:
                ...
                #qry += ", id_kota = \'" + kotanya + "\'"
                qry = 'CALL updatekota(\'' + kotanya + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if provinsinya != "" and provinsinya != None:
                ...
                qry = 'CALL updateprovinsi(\'' + provinsinya + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if notelp != "" and notelp != None:
                ...
                qry = 'CALL updatetelepon(\'' + notelp + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if instagram != "" and instagram != None:
                ...
                qry = 'CALL updateinstagram(\'' + instagram + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            if linkedin != "" and linkedin != None:
                #qry += ", linkedin = \'" + linkedin + "\'"
                qry = 'CALL updatelinkedin(\'' + linkedin + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if email != "" and email != None:
                session["email"] = email
                qry = 'CALL updateemail(\'' + email + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
            ...
            if jobnya != "" and jobnya != None:
                ...
                qry = 'CALL updatetipe(\'' + jobnya + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if tipejob != "" and tipejob != None:
                #qry += ", durasi_pekerjaan = \'" + tipejob + "\'"
                qry = 'CALL updatedurasi(\'' + tipejob + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)

            if gaji != "" and gaji != None:
                #qry += ", preferensi_gaji = \'" + gaji + "\'"
                qry = 'CALL updategaji(\'' + gaji + '\'  , \'' + session[
                    "iduser"].upper() + '\')'
                ExecuteCMD(qry)
